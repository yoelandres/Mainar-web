/* ==========================================================================
   FECHA DE REVELACIÓN DEL PREGONERO
   Cambia aquí el día y la hora en la que quieres que la página se
   desbloquee automáticamente y se muestre la foto y el saludo reales.
   Formato: "AAAA-MM-DDTHH:MM:SS"
   ========================================================================== */
const FECHA_REVELACION_PREGONERO = new Date("2026-08-01T00:00:00");
/* ========================================================================== */
...
// Dibuja una versión "pixelada" (mosaico de bloques) de la foto en el
// canvas que se superpone a la imagen mientras la página está bloqueada.
function pixelarFoto() {
  ...
  const factor = 0.045; // cuanto más bajo, más grandes los "píxeles"
